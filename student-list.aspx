<%@ Page Title="" Language="C#" MasterPageFile="~/AdvisorMaster.master" AutoEventWireup="true" CodeFile="student-list.aspx.cs" Inherits="student_list" %>
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="More Details">
                                <ItemTemplate>
                                    <asp:HyperLink ID="Details" Target="_blank" runat="server" NavigateUrl='<%# Eval("userId", "student-details.aspx?id={0}") %>'
